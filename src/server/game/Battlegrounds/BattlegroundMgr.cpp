...
void BattlegroundMgr::SendAreaSpiritHealerQueryOpcode(Player* player, Battleground* bg, ObjectGuid spiritHealerGUID)
{
    WorldPackets::Battleground::AreaSpiritHealerTime areaSpiritHealerTime;
    areaSpiritHealerTime.HealerGuid = spiritHealerGUID;
    areaSpiritHealerTime.TimeLeft = 30000 - bg->GetLastResurrectTime();      // resurrect every 30 seconds;
...
void BattlegroundMgr::SendBattlegroundList(Player* player, ObjectGuid const& guid, BattlegroundTypeId bgTypeId)
{
    ...
    battlefieldList.Verification = 0; // alistar: TODO it's some sort of verification
