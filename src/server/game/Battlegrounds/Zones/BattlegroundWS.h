...
enum BG_WS_SpellId
{
    ...
    BG_WS_SPELL_WARSONG_FLAG_PICKED     = 301089,
    BG_WS_SPELL_SILVERWING_FLAG         = 23335,
    BG_WS_SPELL_SILVERWING_FLAG_DROPPED = 23336,
    BG_WS_SPELL_SILVERWING_FLAG_PICKED  = 301091,
...
class BattlegroundWS : public Battleground
{
    public:
        ...
        uint8 GetFlagState(Team team)             { return _flagState[GetTeamIndexByTeamId(team)]; }
        ...
        ObjectGuid GetDroppedFlagGUID(Team TeamID)             { return m_DroppedFlagGUID[GetTeamIndexByTeamId(TeamID)]; }

        /* Scorekeeping */
        void AddPoint(Team TeamID, uint32 Points = 1)     { m_TeamScores[GetTeamIndexByTeamId(TeamID)] += Points; }
        void SetTeamPoint(Team TeamID, uint32 Points = 0) { m_TeamScores[GetTeamIndexByTeamId(TeamID)] = Points; }
        void RemovePoint(Team TeamID, uint32 Points = 1)  { m_TeamScores[GetTeamIndexByTeamId(TeamID)] -= Points; }
    ...
    private:
        ...
        // hack..
        std::unordered_map<ObjectGuid, time_t> m_QuickCap;
};
#endif