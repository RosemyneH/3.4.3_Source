...
struct TC_GAME_API LootItem
{
    ...
    LootItem() : itemid(0), itemIndex(0), randomSuffix(0), randomProperties(), context(ItemContext::NONE), count(0), is_looted(false), is_blocked(false),
...
struct TC_GAME_API Loot
{
    ...
    uint32 GetMaxSlotInLootFor(const Player* player) const;
