...
class TC_GAME_API ObjectMgr
{
    ...
    public:
        ...
        typedef std::vector<int64> ActiveCreaturesContainer;
        //void LoadActiveCreatures();
        void AddActiveCreature(int64 id, bool guid);
        bool GetActiveCreature(int64 id, bool guid) const;
    ...
    private:
        ...
        // Entry, GUID
        ActiveCreaturesContainer _activeCreaturesStore;
        ActiveCreaturesContainer _activeCreaturesStoreGUIDs;
