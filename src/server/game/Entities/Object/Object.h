...
class TC_GAME_API WorldObject : public Object, public WorldLocation
{
    ...
    public:
        ...
        void MovePosition(Position &pos, float dist, float angle, float maxHeightChange = 6.0f);
        ...
        void GetCombatPosition(Unit const* searcher, float& x, float& y, float& z, float absAngle, float basedist = -1.f);
        ...
        virtual float MeleeSpellMissChance(Unit const* victim, WeaponAttackType attType, int32 skillDiff, SpellInfo const* spellInfo) const;
