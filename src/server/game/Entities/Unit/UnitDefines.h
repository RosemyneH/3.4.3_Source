...
{
    ACT_PASSIVE  = 0x80,                                    // alistar: 128 - passive
    ACT_DISABLED = 0x8080,                                  // alistar: 32896 - castable
    ACT_ENABLED  = 0xC080,                                  // alistar: 49280 - auto cast + castable
    ACT_COMMAND  = 0x380,                                   // alistar: 896 - COMMANDS
    ACT_REACTION = 0x300,                                   // alistar: reacions (agressive defensive, passive)
    ACT_DECIDE   = 0x00
};
