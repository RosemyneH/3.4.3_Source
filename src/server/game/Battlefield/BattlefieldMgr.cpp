...
namespace
{
constexpr std::array<uint32, BATTLEFIELD_MAX> BattlefieldIdToMapId = { 0, 571 };
constexpr std::array<uint32, BATTLEFIELD_MAX> BattlefieldIdToZoneId = { 0, 4197 }; // imitate World_PVP_Area.db2
std::array<uint32, BATTLEFIELD_MAX> BattlefieldIdToScriptId = { 0, 0 };
}
