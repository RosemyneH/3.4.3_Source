...
void Battlefield::SendAreaSpiritHealerQueryOpcode(Player* player, ObjectGuid spiritHealerGUID)
{
...
void BfGraveyard::RelocateDeadPlayers()
{
    ...
    for (GuidSet::const_iterator itr = m_ResurrectQueue.begin(); itr != m_ResurrectQueue.end(); ++itr)
    {
        ...
        if (closestGrave)
            player->TeleportTo(player->GetMapId(), closestGrave->Loc.m_positionX, closestGrave->Loc.m_positionY, closestGrave->Loc.m_positionZ, player->GetOrientation());
        else
        {
