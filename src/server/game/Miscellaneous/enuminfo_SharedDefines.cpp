...
TC_API_EXPORT EnumText EnumUtils<SpellAttr7>::ToString(SpellAttr7 value)
{
    switch (value)
    {
        ...
        case SPELL_ATTR7_CAN_RESTORE_SECONDARY_POWER: return { "SPELL_ATTR7_ONLY_IN_SPELLBOOK_UNTIL_LEARNED", "Only In Spellbook Until Learned", "After learning these spells become hidden in spellbook (but are visible when not learned for low level characters)" };
...
TC_API_EXPORT EnumText EnumUtils<AuraStateType>::ToString(AuraStateType value)
{
    switch (value)
    {
        ...
        case AURA_STATE_JUDGEMENT: return { "AURA_STATE_MARKED", "AURA_STATE_MARKED", "C  t| NYI" };
        ...
        case AURA_STATE_CONFLAGRATE: return { "AURA_STATE_RAID_ENCOUNTER_2", "AURA_STATE_RAID_ENCOUNTER_2", "cT |" };
...
TC_API_EXPORT AuraStateType EnumUtils<AuraStateType>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 14: return AURA_STATE_CONFLAGRATE;
        case 15: return AURA_STATE_SWIFTMEND;
...
TC_API_EXPORT size_t EnumUtils<AuraStateType>::ToIndex(AuraStateType value)
{
    switch (value)
    {
        ...
        case AURA_STATE_CONFLAGRATE: return 14;
        case AURA_STATE_SWIFTMEND: return 15;
