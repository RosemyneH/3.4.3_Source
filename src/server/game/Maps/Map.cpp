...
bool Map::IsInWater(PhaseShift const& phaseShift, float x, float y, float z, LiquidData* data, float collisionHeight)
{
    return m_terrain->IsInWater(phaseShift, GetId(), x, y, z, data, collisionHeight);
}
...
bool Map::IsNormal() const
{
    switch (i_spawnMode)
    {
        ...
        case DIFFICULTY_RAID_10_N:
        case DIFFICULTY_RAID_25_N:
        case DIFFICULTY_PARTY_NORMAL:
            return true;
        default:
            return false;
    }
...
bool Map::IsHeroic() const
{
    ...
    switch (i_spawnMode)
    {
        ...
        case DIFFICULTY_RAID_10_HC:
        case DIFFICULTY_RAID_25_HC:
        case DIFFICULTY_PARTY_HEROIC:
            return true;
        default:
            return false;
    }
...
{
    return IsRaid() &&
        (i_spawnMode == DIFFICULTY_25_N      || 
         i_spawnMode == DIFFICULTY_25_HC     ||
         i_spawnMode == DIFFICULTY_RAID_25_N ||
         i_spawnMode == DIFFICULTY_RAID_25_HC);
}
