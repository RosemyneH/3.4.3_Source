...
namespace WorldPackets
{
    namespace Battleground
    {
        ...
        {
        public:
            SeasonInfo() : ServerPacket(SMSG_PVP_SEASON, 4 + 4 + 4 + 4 + 4 + 4 + 1) { }
        ...
        public:
            ...
            uint64 PackedBattlegroundQueueTypeID = 0;
            uint8 Roles = 0;
            int32 BlacklistMap[2] = { };
            ObjectGuid BattlemasterGuid;
            int32 UnkID = 0; // reused from SMSG_BATTLEFIELD_LIST
        ...
        {
        public:
            BattlefieldList() : ServerPacket(SMSG_BATTLEFIELD_LIST, 16 + 4 + 4 + 1 + 1 + (4 * 13) + 1 + 1) { }

            WorldPacket const* Write() override;

            ObjectGuid BattlemasterGuid;
            int32 Verification = 0;
            int32 BattlemasterListID = 0;
            uint8 MinLevel = 0;
            uint8 MaxLevel = 0;
            std::array<int32, 13> Battlefields { 1, 1, 1, 1, 2, 2, 2, 3, 3, 3, 4, 4, 5 };
