...
namespace WorldPackets
{
    namespace AuctionHouse
    {
        ...
        {
        public:
            AuctionBrowseQuery(WorldPacket&& packet) : ClientPacket(CMSG_AUCTION_LIST_ITEMS, std::move(packet)) { }
        ...
        {
        public:
            AuctionListBiddedItems(WorldPacket&& packet) : ClientPacket(CMSG_AUCTION_LIST_BIDDER_ITEMS, std::move(packet)) { }

            void Read() override;

            ObjectGuid Auctioneer;
            uint32 Offset = 0;
            uint32 AuctionItemIDsCount = 0;
        };
        ...
        public:
            ...
            uint8 MinLevel = 1;
            uint8 MaxLevel = MAX_LEVEL;
            int32 Quality = ItemQualities::ITEM_QUALITY_POOR;
            uint8 SortCount = 0;
            uint32 KnownPetsCount = 0;
            int8 MaxPetLevel = 0;

            bool Unknown343 = false;
            std::string Name;

            uint32 ClassFilterCount = 0;
            Array<AuctionListFilterClass, 7> ItemClassFilters;
        ...
        {
        public:
            AuctionListOwnedItems(WorldPacket&& packet) : ClientPacket(CMSG_AUCTION_LIST_OWNER_ITEMS, std::move(packet)) { }
        ...
        {
        public:
            AuctionHelloResponse() : ServerPacket(SMSG_AUCTION_HELLO_RESPONSE, 16 + 4 + 4 + 4 + 1) { }
        ...
        {
        public:
            AuctionListBiddedItemsResult() : ServerPacket(SMSG_AUCTION_LIST_BIDDER_ITEMS_RESULT, 149) { }
        ...
        {
        public:
            AuctionListOwnedItemsResult() : ServerPacket(SMSG_AUCTION_LIST_OWNER_ITEMS_RESULT, 149) { }
