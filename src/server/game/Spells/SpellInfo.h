...
class TC_GAME_API SpellInfo
{
    ...
    public:
        ...
        Optional<SpellPowerCost> CalcPowerCost(Powers powerType, WorldObject const* caster, SpellSchoolMask schoolMask, Spell* spell = nullptr) const;
        Optional<SpellPowerCost> CalcPowerCost(SpellPowerEntry const* power, WorldObject const* caster, SpellSchoolMask schoolMask, Spell* spell = nullptr) const;
