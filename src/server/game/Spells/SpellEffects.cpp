...
NonDefaultConstructible<SpellEffectHandlerFn> SpellEffectHandlers[TOTAL_SPELL_EFFECTS] =
{
    ...
    &Spell::EffectAddHonor,                                 // 45 SPELL_EFFECT_ADD_HONOR
    ...
    // Alistar: any new effects that only exist in 3.4.3
    ...
    &Spell::EffectUnused,                                   //167
    &Spell::EffectUnused,                                   //168
    ...
    &Spell::EffectUnused,                                   //171
    &Spell::EffectUnused,                                   //172
    &Spell::EffectUnused,                                   //173
    &Spell::EffectApplyAura,                                //174 SPELL_EFFECT_APPLY_AURA_ON_PET
    &Spell::EffectUnused,                                   //175
    &Spell::EffectUnused,                                   //176
    &Spell::EffectUnused,                                   //177
    &Spell::EffectUnused,                                   //178
    &Spell::EffectCreateAreaTrigger,                        //179 SPELL_EFFECT_CREATE_AREATRIGGER
    &Spell::EffectUnused,                                   //180
    &Spell::EffectUnused,                                   //181
    &Spell::EffectUnused,                                   //182
    &Spell::EffectUnused,                                   //183
    &Spell::EffectUnused,                                   //184
    &Spell::EffectUnused,                                   //185
    &Spell::EffectUnused,                                   //186
    &Spell::EffectUnused,                                   //187
    &Spell::EffectUnused,                                   //188
    &Spell::EffectNULL,                                     //189 SPELL_EFFECT_LOOT                                          
    &Spell::EffectUnused,                                   //190 SPELL_EFFECT_CHANGE_PARTY_MEMBERS
    &Spell::EffectUnused,                                   //191 SPELL_EFFECT_TELEPORT_TO_DIGSITE
    &Spell::EffectUnused,                                   //192 SPELL_EFFECT_UNCAGE_BATTLEPET
    &Spell::EffectUnused,                                   //193 SPELL_EFFECT_START_PET_BATTLE
    &Spell::EffectUnused,                                   //194 SPELL_EFFECT_194
    &Spell::EffectUnused,                                   //195 SPELL_EFFECT_PLAY_SCENE_SCRIPT_PACKAGE
    &Spell::EffectUnused,                                   //196 SPELL_EFFECT_CREATE_SCENE_OBJECT
    &Spell::EffectUnused,                                   //197 SPELL_EFFECT_CREATE_PERSONAL_SCENE_OBJECT
    &Spell::EffectUnused,                                   //198 SPELL_EFFECT_PLAY_SCENE
    &Spell::EffectUnused,                                   //199 SPELL_EFFECT_DESPAWN_SUMMON
    &Spell::EffectUnused,                                   //200 SPELL_EFFECT_HEAL_BATTLEPET_PCT
    &Spell::EffectUnused,                                   //201 SPELL_EFFECT_ENABLE_BATTLE_PETS
    &Spell::EffectUnused,                                   //202 SPELL_EFFECT_APPLY_AREA_AURA_SUMMONS
    &Spell::EffectUnused,                                   //203 SPELL_EFFECT_REMOVE_AURA_2
    &Spell::EffectUnused,                                   //204 SPELL_EFFECT_CHANGE_BATTLEPET_QUALITY
    &Spell::EffectUnused,                                   //205 SPELL_EFFECT_LAUNCH_QUEST_CHOICE
    &Spell::EffectUnused,                                   //206 SPELL_EFFECT_ALTER_ITEM
    &Spell::EffectUnused,                                   //207 SPELL_EFFECT_LAUNCH_QUEST_TASK
    &Spell::EffectUnused,                                   //208 SPELL_EFFECT_SET_REPUTATION
    &Spell::EffectUnused,                                   //209 SPELL_EFFECT_209
    &Spell::EffectUnused,                                   //210 SPELL_EFFECT_LEARN_GARRISON_BUILDING
    &Spell::EffectUnused,                                   //211 SPELL_EFFECT_LEARN_GARRISON_SPECIALIZATION
    &Spell::EffectUnused,                                   //212 SPELL_EFFECT_REMOVE_AURA_BY_SPELL_LABEL
    &Spell::EffectUnused,                                   //213 SPELL_EFFECT_JUMP_DEST_2
    &Spell::EffectUnused,                                   //214 SPELL_EFFECT_CREATE_GARRISON
    &Spell::EffectUnused,                                   //215 SPELL_EFFECT_UPGRADE_CHARACTER_SPELLS
    &Spell::EffectUnused,                                   //216 SPELL_EFFECT_CREATE_SHIPMENT
    &Spell::EffectUnused,                                   //217 SPELL_EFFECT_UPGRADE_GARRISON
    &Spell::EffectUnused,                                   //218 SPELL_EFFECT_218
    &Spell::EffectUnused,                                   //219 SPELL_EFFECT_CREATE_CONVERSATION
    &Spell::EffectUnused,                                   //220 SPELL_EFFECT_ADD_GARRISON_FOLLOWER
    &Spell::EffectUnused,                                   //221 SPELL_EFFECT_ADD_GARRISON_MISSION
    &Spell::EffectCreateHeirloomItem,                       //222 SPELL_EFFECT_CREATE_HEIRLOOM_ITEM
    &Spell::EffectUnused,                                   //223 SPELL_EFFECT_CHANGE_ITEM_BONUSES
    &Spell::EffectUnused,                                   //224 SPELL_EFFECT_ACTIVATE_GARRISON_BUILDING
    &Spell::EffectUnused,                                   //225 SPELL_EFFECT_GRANT_BATTLEPET_LEVEL
    &Spell::EffectNULL,                                     //226 SPELL_EFFECT_TRIGGER_ACTION_SET
    &Spell::EffectUnused,                                   //227 SPELL_EFFECT_TELEPORT_TO_LFG_DUNGEON
    &Spell::EffectUnused,                                   //228 SPELL_EFFECT_228
    &Spell::EffectUnused,                                   //229 SPELL_EFFECT_SET_FOLLOWER_QUALITY
    &Spell::EffectUnused,                                   //230 SPELL_EFFECT_230
    &Spell::EffectUnused,                                   //231 SPELL_EFFECT_INCREASE_FOLLOWER_EXPERIENCE
    &Spell::EffectUnused,                                   //232 SPELL_EFFECT_REMOVE_PHASE
    &Spell::EffectUnused,                                   //233 SPELL_EFFECT_RANDOMIZE_FOLLOWER_ABILITIES
    &Spell::EffectUnused,                                   //234 SPELL_EFFECT_234
    &Spell::EffectUnused,                                   //235 SPELL_EFFECT_235
    &Spell::EffectUnused,                                   //236 SPELL_EFFECT_GIVE_EXPERIENCE
    &Spell::EffectUnused,                                   //237 SPELL_EFFECT_GIVE_RESTED_EXPERIENCE_BONUS
    &Spell::EffectUnused,                                   //238 SPELL_EFFECT_INCREASE_SKILL
    &Spell::EffectUnused,                                   //239 SPELL_EFFECT_END_GARRISON_BUILDING_CONSTRUCTION
    ...
    &Spell::EffectUnused,                                   //243 SPELL_EFFECT_APPLY_ENCHANT_ILLUSION
    &Spell::EffectUnused,                                   //244 SPELL_EFFECT_LEARN_FOLLOWER_ABILITY
    &Spell::EffectUnused,                                   //245 SPELL_EFFECT_UPGRADE_HEIRLOOM
    &Spell::EffectUnused,                                   //246 SPELL_EFFECT_FINISH_GARRISON_MISSION
    &Spell::EffectUnused,                                   //247 SPELL_EFFECT_ADD_GARRISON_MISSION_SET
    &Spell::EffectUnused,                                   //248 SPELL_EFFECT_FINISH_SHIPMENT
    &Spell::EffectUnused,                                   //249 SPELL_EFFECT_FORCE_EQUIP_ITEM
    &Spell::EffectUnused,                                   //250 SPELL_EFFECT_TAKE_SCREENSHOT
    &Spell::EffectUnused,                                   //251 SPELL_EFFECT_SET_GARRISON_CACHE_SIZE
    &Spell::EffectUnused,                                   //252
    &Spell::EffectUnused,                                   //253
    &Spell::EffectUnused,                                   //254 SPELL_EFFECT_JUMP_CHARGE
    &Spell::EffectUnused,                                   //255 SPELL_EFFECT_LEARN_TRANSMOG_SET
    &Spell::EffectUnused,                                   //256 SPELL_EFFECT_256
    &Spell::EffectUnused,                                   //257 SPELL_EFFECT_257
    &Spell::EffectUnused,                                   //258 SPELL_EFFECT_MODIFY_KEYSTONE
    &Spell::EffectUnused,                                   //259 SPELL_EFFECT_RESPEC_AZERITE_EMPOWERED_ITEM
    &Spell::EffectUnused,                                   //260 SPELL_EFFECT_SUMMON_STABLED_PET
    &Spell::EffectUnused,                                   //261 SPELL_EFFECT_SCRAP_ITEM
    &Spell::EffectUnused,                                   //262 SPELL_EFFECT_262
    &Spell::EffectUnused,                                   //263 SPELL_EFFECT_REPAIR_ITEM
    &Spell::EffectUnused,                                   //264 SPELL_EFFECT_REMOVE_GEM
    &Spell::EffectUnused,                                   //265 SPELL_EFFECT_LEARN_AZERITE_ESSENCE_POWER
    &Spell::EffectUnused,                                   //266 SPELL_EFFECT_SET_ITEM_BONUS_LIST_GROUP_ENTRY
    &Spell::EffectUnused,                                   //267 SPELL_EFFECT_CREATE_PRIVATE_CONVERSATION
    &Spell::EffectUnused,                                   //268 SPELL_EFFECT_APPLY_MOUNT_EQUIPMENT
    &Spell::EffectUnused,                                   //269 SPELL_EFFECT_INCREASE_ITEM_BONUS_LIST_GROUP_STEP
    &Spell::EffectUnused,                                   //270 SPELL_EFFECT_270
    &Spell::EffectUnused,                                   //271 SPELL_EFFECT_APPLY_AREA_AURA_PARTY_NONRANDOM
    &Spell::EffectUnused,                                   //272 SPELL_EFFECT_SET_COVENANT
    &Spell::EffectUnused,                                   //273 SPELL_EFFECT_CRAFT_RUNEFORGE_LEGENDARY
    &Spell::EffectUnused,                                   //274 SPELL_EFFECT_274
    &Spell::EffectUnused,                                   //275 SPELL_EFFECT_275
    &Spell::EffectUnused,                                   //276 SPELL_EFFECT_LEARN_TRANSMOG_ILLUSION
    &Spell::EffectUnused,                                   //277 SPELL_EFFECT_SET_CHROMIE_TIME
    &Spell::EffectUnused,                                   //278 SPELL_EFFECT_278
    &Spell::EffectUnused,                                   //279 SPELL_EFFECT_LEARN_GARR_TALENT
    &Spell::EffectUnused,                                   //280 SPELL_EFFECT_280
    &Spell::EffectUnused,                                   //281 SPELL_EFFECT_LEARN_SOULBIND_CONDUIT
    &Spell::EffectUnused,                                   //282 SPELL_EFFECT_CONVERT_ITEMS_TO_CURRENCY
    &Spell::EffectUnused,                                   //283 SPELL_EFFECT_COMPLETE_CAMPAIGN
    &Spell::EffectUnused,                                   //284 SPELL_EFFECT_SEND_CHAT_MESSAGE
    &Spell::EffectUnused,                                   //285 SPELL_EFFECT_MODIFY_KEYSTONE_2
    &Spell::EffectUnused,                                   //286 SPELL_EFFECT_GRANT_BATTLEPET_EXPERIENCE
    &Spell::EffectUnused,                                   //287 SPELL_EFFECT_SET_GARRISON_FOLLOWER_LEVEL
    &Spell::EffectUnused,                                   //288 SPELL_EFFECT_CRAFT_ITEM
    &Spell::EffectUnused,                                   //289 SPELL_EFFECT_MODIFY_AURA_STACKS
    &Spell::EffectUnused,                                   //290 SPELL_EFFECT_MODIFY_COOLDOWN
    &Spell::EffectUnused,                                   //291 SPELL_EFFECT_MODIFY_COOLDOWNS
    &Spell::EffectUnused,                                   //292 SPELL_EFFECT_MODIFY_COOLDOWNS_BY_CATEGORY
    &Spell::EffectUnused,                                   //293 SPELL_EFFECT_MODIFY_CHARGES
    &Spell::EffectUnused,                                   //294 SPELL_EFFECT_CRAFT_LOOT
    &Spell::EffectUnused,                                   //295 SPELL_EFFECT_SALVAGE_ITEM
    &Spell::EffectUnused,                                   //296 SPELL_EFFECT_CRAFT_SALVAGE_ITEM
    &Spell::EffectUnused,                                   //297 SPELL_EFFECT_RECRAFT_ITEM
    &Spell::EffectUnused,                                   //298 SPELL_EFFECT_CANCEL_ALL_PRIVATE_CONVERSATIONS
    &Spell::EffectUnused,                                   //299 SPELL_EFFECT_299
    &Spell::EffectUnused,                                   //300 SPELL_EFFECT_300
    &Spell::EffectUnused,                                   //301 SPELL_EFFECT_CRAFT_ENCHANT
    &Spell::EffectUnused,                                   //302 SPELL_EFFECT_GATHERING
    &Spell::EffectUnused,                                   //303 SPELL_EFFECT_CREATE_TRAIT_TREE_CONFIG
    &Spell::EffectUnused,                                   //304 SPELL_EFFECT_CHANGE_ACTIVE_COMBAT_TRAIT_CONFIG
    &Spell::EffectUnused,                                   //305 SPELL_EFFECT_305
    &Spell::EffectUnused,                                   //306 SPELL_EFFECT_UPDATE_INTERACTIONS
    &Spell::EffectUnused,                                   //307 SPELL_EFFECT_307
    &Spell::EffectUnused,                                   //308 SPELL_EFFECT_CANCEL_PRELOAD_WORLD
    &Spell::EffectUnused,                                   //309 SPELL_EFFECT_PRELOAD_WORLD
    &Spell::EffectUnused,                                   //310 SPELL_EFFECT_310
    &Spell::EffectUnused,                                   //311 SPELL_EFFECT_ENSURE_WORLD_LOADED
    &Spell::EffectUnused,                                   //312 SPELL_EFFECT_312
    &Spell::EffectUnused,                                   //313 SPELL_EFFECT_CHANGE_ITEM_BONUSES_2
    &Spell::EffectUnused,                                   //314 SPELL_EFFECT_ADD_SOCKET_BONUS
    &Spell::EffectUnused,                                   //315 SPELL_EFFECT_LEARN_TRANSMOG_APPEARANCE_FROM_ITEM_MOD_APPEARANCE_GROUP
};
    ...
    if (unitTarget && unitTarget->IsAlive())
    {
        ...
        switch (m_spellInfo->SpellFamilyName)
        {
            ...
            case SPELLFAMILY_WARLOCK:
            {
                ...
                // Incinerate Rank 1 & 2
                if ((m_spellInfo->SpellFamilyFlags[1] & 0x000040) && m_spellInfo->IconFileDataId == 135789)
                {
                ...
                else if (m_spellInfo->SpellFamilyFlags[1] & 0x400000)
                {
                    if (unitCaster->GetTypeId() == TYPEID_UNIT && unitCaster->IsPet())
                    {
                        ...
                        {
                            if (AuraEffect* aurEff = owner->GetAuraEffect(SPELL_AURA_ADD_FLAT_MODIFIER, SPELLFAMILY_WARLOCK, 136217, 0))
                            {
            ...
            case SPELLFAMILY_PRIEST:
            {
                ...
                if (unitCaster->GetShapeshiftForm() == FORM_SHADOWFORM && (m_spellInfo->SpellFamilyFlags[0] & 0x00002000))
                {
                    ...
                    for (Unit::AuraEffectList::const_iterator i = ImprMindBlast.begin(); i != ImprMindBlast.end(); ++i)
                    {
                        if ((*i)->GetSpellInfo()->SpellFamilyName == SPELLFAMILY_PRIEST &&
                            ((*i)->GetSpellInfo()->IconFileDataId == 136224))
                        {
                            // Mind Trauma
            ...
            case SPELLFAMILY_DRUID:
            {
                ...
                // Ferocious Bite
                if (unitCaster->GetTypeId() == TYPEID_PLAYER && (m_spellInfo->SpellFamilyFlags[0] & 0x000800000) && m_spellInfo->GetSpellVisual() == 6587)
                {
                ...
                else if (m_spellInfo->SpellFamilyFlags[0] & 0x00000001)
                {
                    ...
                    if (AuraEffect const* aurEff = unitCaster->GetDummyAuraEffect(SPELLFAMILY_DRUID, 136045, 0))
                    ...
                    if (Player* player = unitCaster->ToPlayer())
                    {
                        ...
                        if (uint32 combo = player->GetComboPoints())
                        {
                            ...
                            if (AuraEffect const* aurEff = unitTarget->GetAuraEffect(SPELL_AURA_PERIODIC_DAMAGE, SPELLFAMILY_ROGUE, 0x00010000, 0, 0, unitCaster->GetGUID()))
                            {
                                ...
                                {
                                    if ((*iter)->GetSpellInfo()->SpellFamilyName == SPELLFAMILY_ROGUE && (*iter)->GetSpellInfo()->IconFileDataId == 132108)
                                    {
            ...
            case SPELLFAMILY_HUNTER:
            {
                ...
                //Gore
                if (m_spellInfo->IconFileDataId == 132184)
                {
                ...
                else if (m_spellInfo->SpellFamilyFlags[1] & 0x1)
                {
                    ...
                    {
                        if ((*iter)->GetSpellInfo()->IconFileDataId == 135860 && (*iter)->GetSpellInfo()->Dispel == 0)
                        {
                            found = true;
                            break;
                        }
                    ...
                    if (Player* caster = unitCaster->ToPlayer())
                    {
                        ...
                        damage += int32(caster->GetAmmoDPS() * caster->GetBaseAttackTime(RANGED_ATTACK) * 0.001f);
                    }
                }
                break;
            }
            case SPELLFAMILY_PALADIN:
            {
                ...
                if (m_spellInfo->SpellFamilyFlags[1] & 0x00040000)
                {
                    ...
                    damage += count * int32(average * float(IN_MILLISECONDS)) / unitCaster->GetBaseAttackTime(BASE_ATTACK);
                    break;
                }
...
void Spell::EffectPersistentAA()
{
    ...
    createInfo
        ...
        .SetBaseAmount(m_spellValue->EffectBasePoints.data())
...
void Spell::EffectEnergize()
{
    ...
    if (unitTarget->GetTypeId() == TYPEID_PLAYER && 
        unitTarget->GetPowerType() != power && m_spellInfo->SpellFamilyName != SPELLFAMILY_POTION && 
        !m_spellInfo->HasAttribute(SPELL_ATTR7_CAN_RESTORE_SECONDARY_POWER) &&
        power != POWER_RUNE_BLOOD &&
        power != POWER_RUNE_FROST &&
        power != POWER_RUNE_UNHOLY)
    {
        return;
    }
    ...
    if (gameObjTarget)
    {
        ...
        switch (gameObjTarget->GetGoType())
        {
            ...
            case GAMEOBJECT_TYPE_CHEST:
                ...
                // alistar: do open chest animation.. for some reason this was missing
                // also set looting state so we see crouch down animation
...
void Spell::EffectLearnSpell()
{
        ...
        for (ItemEffectEntry const* itemEffect : m_CastItem->GetEffects())
        {
            ...
            if (BattlePetSpeciesEntry const* speciesEntry = BattlePets::BattlePetMgr::GetBattlePetSpeciesBySpell(uint32(itemEffect->SpellID)))
            {
                player->GetSession()->GetBattlePetMgr()->AddPet(speciesEntry->ID, BattlePets::BattlePetMgr::SelectPetDisplay(speciesEntry),
                    BattlePets::BattlePetMgr::RollPetBreed(speciesEntry->ID), BattlePets::BattlePetMgr::GetDefaultPetQuality(speciesEntry->ID), itemEffect->SpellID);
    ...
    const uint32 spellToLearn = (m_spellInfo->Id == 483 || m_spellInfo->Id == 55884) ? damage : effectInfo->TriggerSpell;
...
void Spell::EffectDispel()
{
    ...
    for (int32 count = 0; count < damage && remaining > 0;)
    {
        ...
        if (itr->RollDispel())
        {
            ...
            const uint8 dispelledCharges = 1;
...
void Spell::EffectWeaponDmg()
{
    ...
    switch (m_spellInfo->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_ROGUE:
        {
            ...
            else if (m_spellInfo->SpellFamilyFlags[1] & 0x6)
            {
                bool found = false;
                // fast check
                if (unitTarget->HasAuraState(AURA_STATE_ROGUE_POISONED, m_spellInfo, unitCaster))
                    found = true;
                // full aura scan
                else
                {
        ...
        case SPELLFAMILY_DRUID:
        {
            ...
            else if (m_spellInfo->SpellFamilyFlags[0] & 0x00008800 && unitTarget->HasAuraState(AURA_STATE_BLEED))
            {
                if (AuraEffect const* rendAndTear = unitCaster->GetDummyAuraEffect(SPELLFAMILY_DRUID, 236164, 0))
        ...
        case SPELLFAMILY_DEATHKNIGHT:
        {
            ...
            if (m_spellInfo->SpellFamilyFlags[1] & 0x20000)
            {
                ...
                // Annihilation
                if (AuraEffect const* aurEff = unitCaster->GetDummyAuraEffect(SPELLFAMILY_DEATHKNIGHT, 135609, EFFECT_0))
            ...
            if (m_spellInfo->IconFileDataId == 132103)
            {
    ...
    if (Player* modOwner = unitCaster->GetSpellModOwner())
        modOwner->ApplySpellMod(m_spellInfo, SpellModOp::HealingAndDamage, weaponDamage);
        ...
        if (Spell* spell = unitTarget->GetCurrentSpell(CurrentSpellTypes(i)))
        {
                ...
                && curSpellInfo->CanBeInterrupted(m_caster, unitTarget))
            {
                if (Unit* unitCaster = GetUnitCasterForEffectHandlers())
                {
                    ...
                    unitTarget->GetSpellHistory()->LockSpellSchool(curSpellInfo->GetSchoolMask(), Milliseconds(unitTarget->ModSpellDuration(m_spellInfo, unitTarget, duration, false, 1 << effectInfo->EffectIndex)));

                    if (m_spellInfo->DmgClass == SPELL_DAMAGE_CLASS_MAGIC)
                        Unit::ProcSkillsAndAuras(unitCaster, unitTarget, PROC_FLAG_DEAL_HARMFUL_SPELL, PROC_FLAG_TAKE_HARMFUL_SPELL,
                        ...
                        Unit::ProcSkillsAndAuras(unitCaster, unitTarget, PROC_FLAG_DEAL_MELEE_ABILITY, PROC_FLAG_TAKE_MELEE_ABILITY,
                            PROC_SPELL_TYPE_MASK_ALL, PROC_SPELL_PHASE_HIT, PROC_HIT_INTERRUPT, nullptr, nullptr, nullptr);
                }
...
void Spell::EffectFeedPet()
{
    ...
    int32 benefit = pet->GetCurrentFoodBenefitLevel(foodItem->GetTemplate()->GetItemLevel());
    if (benefit <= 0)
        return;
...
void Spell::EffectSummonObject()
{
    ...
    if (m_targets.HasDst())
    {
        ...
        // alistar: add trap leeway
        if (Player* caster = m_caster->ToPlayer())
            if (caster->isMoving())
                if (m_spellInfo->GetEffect(effectInfo->EffectIndex).HasRadius(SpellTargetIndex::TargetA))
                    caster->GetClosePoint(x, y, z, effectInfo->TargetARadiusEntry->RadiusMin + DEFAULT_LEEWAY_RANGE);
    }
...
void Spell::EffectCharge()
{
    ...
    if (effectHandleMode == SPELL_EFFECT_HANDLE_HIT_TARGET)
    {
        ...
        // alistar: handled in PointMovementGenerator
...
void Spell::EffectTalentSpecCount()
{
    ...
    playerCaster->SendTalentsInfoData(false);
}
...
void Spell::EffectGiveExperience()
{
    ...
    uint32 xp = Quest::XPValue(playerTarget->GetLevel(), effectInfo->MiscValue, effectInfo->MiscValueB);
