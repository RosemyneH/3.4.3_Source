...
NonDefaultConstructible<pAuraEffectHandler> AuraEffectHandler[TOTAL_AURAS]=
{
    ...
    &AuraEffect::HandleUnused,                                    //249 unused - alistar: in 3.3.5a this used to be SPELL_AURA_CONVERT_RUNE in classic it's AURA_512
    ...
    &AuraEffect::HandleNoImmediateEffect,                         //274 SPELL_AURA_ABILITY_CONSUME_NO_AMMO implemented in Spell:HandleLaunchPhase
    ...
    &AuraEffect::HandleNoImmediateEffect,                         //277 SPELL_AURA_MOD_MAX_AFFECTED_TARGETS implemented in spell::settargetmap
    ...
    &AuraEffect::HandleUnused,                                    //317 unused
    &AuraEffect::HandleUnused,                                    //318 unused
    &AuraEffect::HandleUnused,                                    //319 unused
    &AuraEffect::HandleUnused,                                    //320 unused
    &AuraEffect::HandleUnused,                                    //321 unused
    &AuraEffect::HandleUnused,                                    //322 unused
    &AuraEffect::HandleUnused,                                    //323 unused
    &AuraEffect::HandleUnused,                                    //324 unused
    &AuraEffect::HandleUnused,                                    //325 unused
    &AuraEffect::HandlePhaseGroup,                                //326 SPELL_AURA_PHASE_GROUP
    &AuraEffect::HandleUnused,                                    //327 unused
    &AuraEffect::HandleUnused,                                    //328 unused
    &AuraEffect::HandleUnused,                                    //329 unused
    &AuraEffect::HandleUnused,                                    //330 unused
    &AuraEffect::HandleUnused,                                    //331 unused
    &AuraEffect::HandleUnused,                                    //332 unused
    &AuraEffect::HandleUnused,                                    //333 unused
    &AuraEffect::HandleUnused,                                    //334 unused
    &AuraEffect::HandleUnused,                                    //335 unused
    &AuraEffect::HandleMountRestrictions,                         //336 SPELL_AURA_MOUNT_RESTRICTIONS implemented in Unit::GetMountCapability
    &AuraEffect::HandleUnused,                                    //337 unused
    &AuraEffect::HandleUnused,                                    //338 unused
    &AuraEffect::HandleUnused,                                    //339 unused
    &AuraEffect::HandleUnused,                                    //340 unused
    &AuraEffect::HandleUnused,                                    //341 unused
    &AuraEffect::HandleUnused,                                    //342 unused
    &AuraEffect::HandleUnused,                                    //343 unused
    &AuraEffect::HandleUnused,                                    //344 unused
    &AuraEffect::HandleUnused,                                    //345 unused
    &AuraEffect::HandleUnused,                                    //346 unused
    &AuraEffect::HandleUnused,                                    //347 unused
    &AuraEffect::HandleUnused,                                    //348 unused
    &AuraEffect::HandleNoImmediateEffect,                         //349 SPELL_AURA_MOD_CURRENCY_GAIN implemented in Player::ModifyCurrency
    &AuraEffect::HandleUnused,                                    //350 unused
    &AuraEffect::HandleUnused,                                    //351 unused
    &AuraEffect::HandleUnused,                                    //352 unused
    &AuraEffect::HandleUnused,                                    //353 unused
    &AuraEffect::HandleUnused,                                    //354 unused
    &AuraEffect::HandleUnused,                                    //355 unused
    &AuraEffect::HandleUnused,                                    //356 unused
    &AuraEffect::HandleUnused,                                    //357 unused
    &AuraEffect::HandleUnused,                                    //358 unused
    &AuraEffect::HandleUnused,                                    //359 unused
    &AuraEffect::HandleUnused,                                    //360 unused
    &AuraEffect::HandleUnused,                                    //361 unused
    &AuraEffect::HandleUnused,                                    //362 unused
    &AuraEffect::HandleUnused,                                    //363 unused
    &AuraEffect::HandleUnused,                                    //364 unused
    &AuraEffect::HandleUnused,                                    //365 unused
    &AuraEffect::HandleUnused,                                    //366 unused
    &AuraEffect::HandleUnused,                                    //367 unused
    &AuraEffect::HandleUnused,                                    //368 unused
    &AuraEffect::HandleUnused,                                    //369 unused
    &AuraEffect::HandleUnused,                                    //370 unused
    &AuraEffect::HandleUnused,                                    //371 unused
    &AuraEffect::HandleUnused,                                    //372 unused
    &AuraEffect::HandleUnused,                                    //373 unused
    &AuraEffect::HandleUnused,                                    //374 unused
    &AuraEffect::HandleUnused,                                    //375 unused
    &AuraEffect::HandleUnused,                                    //376 unused
    &AuraEffect::HandleUnused,                                    //377 unused
    &AuraEffect::HandleUnused,                                    //378 unused
    &AuraEffect::HandleUnused,                                    //379 unused
    &AuraEffect::HandleUnused,                                    //380 unused
    &AuraEffect::HandleUnused,                                    //381 unused
    &AuraEffect::HandleUnused,                                    //382 unused
    &AuraEffect::HandleUnused,                                    //383 unused
    &AuraEffect::HandleUnused,                                    //384 unused
    &AuraEffect::HandleUnused,                                    //385 unused
    &AuraEffect::HandleUnused,                                    //386 unused
    &AuraEffect::HandleUnused,                                    //387 unused
    &AuraEffect::HandleUnused,                                    //388 unused
    &AuraEffect::HandleUnused,                                    //389 unused
    &AuraEffect::HandleUnused,                                    //390 unused
    &AuraEffect::HandleUnused,                                    //391 unused
    &AuraEffect::HandleUnused,                                    //392 unused
    &AuraEffect::HandleUnused,                                    //393 unused
    ...
    &AuraEffect::HandleUnused,                                    //396 unused
    ...
    &AuraEffect::HandleUnused,                                    //399 unused
    &AuraEffect::HandleUnused,                                    //400 unused
    &AuraEffect::HandleUnused,                                    //401 unused
    &AuraEffect::HandleUnused,                                    //402 unused
    &AuraEffect::HandleUnused,                                    //403 unused
    &AuraEffect::HandleUnused,                                    //404 unused
    &AuraEffect::HandleUnused,                                    //405 unused
    &AuraEffect::HandleUnused,                                    //406 unused
    &AuraEffect::HandleNULL,                                      //407 SPELL_AURA_MOD_FEAR_2 - @TODO
    &AuraEffect::HandleUnused,                                    //408 unused
    &AuraEffect::HandleUnused,                                    //409 unused
    &AuraEffect::HandleUnused,                                    //410 unused
    &AuraEffect::HandleUnused,                                    //411 unused
    &AuraEffect::HandleUnused,                                    //412 unused
    &AuraEffect::HandleUnused,                                    //413 unused
    &AuraEffect::HandleUnused,                                    //414 unused
    &AuraEffect::HandleUnused,                                    //415 unused
    &AuraEffect::HandleUnused,                                    //416 unused
    &AuraEffect::HandleUnused,                                    //417 unused
    &AuraEffect::HandleUnused,                                    //418 unused
    &AuraEffect::HandleAuraModIncreaseBaseManaPercent,            //419 SPELL_AURA_MOD_BASE_MANA_PCT
    &AuraEffect::HandleUnused,                                    //420 unused
    &AuraEffect::HandleUnused,                                    //421 unused
    &AuraEffect::HandleUnused,                                    //422 unused
    &AuraEffect::HandleUnused,                                    //423 unused
    &AuraEffect::HandleUnused,                                    //424 unused
    &AuraEffect::HandleUnused,                                    //425 unused
    &AuraEffect::HandleUnused,                                    //426 unused
    &AuraEffect::HandleUnused,                                    //427 unused
    &AuraEffect::HandleUnused,                                    //428 unused
    &AuraEffect::HandleUnused,                                    //429 unused
    &AuraEffect::HandleUnused,                                    //430 unused
    &AuraEffect::HandleUnused,                                    //431 unused
    &AuraEffect::HandleUnused,                                    //432 unused
    &AuraEffect::HandleUnused,                                    //433 unused
    &AuraEffect::HandleUnused,                                    //434 unused
    &AuraEffect::HandleUnused,                                    //435 unused
    &AuraEffect::HandleUnused,                                    //436 unused
    &AuraEffect::HandleUnused,                                    //437 unused
    &AuraEffect::HandleUnused,                                    //438 unused
    &AuraEffect::HandleUnused,                                    //439 unused
    &AuraEffect::HandleUnused,                                    //440 unused
    &AuraEffect::HandleUnused,                                    //441 unused
    &AuraEffect::HandleUnused,                                    //442 unused
    &AuraEffect::HandleUnused,                                    //443 unused
    &AuraEffect::HandleUnused,                                    //444 unused
    &AuraEffect::HandleUnused,                                    //445 unused
    &AuraEffect::HandleUnused,                                    //446 unused
    &AuraEffect::HandleUnused,                                    //447 unused
    &AuraEffect::HandleUnused,                                    //448 unused
    &AuraEffect::HandleUnused,                                    //449 unused
    &AuraEffect::HandleUnused,                                    //450 unused
    &AuraEffect::HandleUnused,                                    //451 unused
    &AuraEffect::HandleUnused,                                    //452 unused
    &AuraEffect::HandleUnused,                                    //453 unused
    &AuraEffect::HandleUnused,                                    //454 unused
    &AuraEffect::HandleAuraModRoot,                               //455 SPELL_AURA_MOD_ROOT_2
    &AuraEffect::HandleUnused,                                    //456 unused
    &AuraEffect::HandleUnused,                                    //457 unused
    &AuraEffect::HandleUnused,                                    //458 unused
    &AuraEffect::HandleUnused,                                    //459 unused
    &AuraEffect::HandleUnused,                                    //460 unused
    &AuraEffect::HandleUnused,                                    //461 unused
    &AuraEffect::HandleUnused,                                    //462 unused
    &AuraEffect::HandleUnused,                                    //463 unused
    &AuraEffect::HandleUnused,                                    //464 unused
    &AuraEffect::HandleUnused,                                    //465 unused
    &AuraEffect::HandleUnused,                                    //466 unused
    &AuraEffect::HandleUnused,                                    //467 unused
    &AuraEffect::HandleUnused,                                    //468 unused
    &AuraEffect::HandleUnused,                                    //469 unused
    &AuraEffect::HandleUnused,                                    //470 unused
    &AuraEffect::HandleUnused,                                    //471 unused
    &AuraEffect::HandleAuraModFixate,                             //472 SPELL_AURA_MOD_FIXATE
    &AuraEffect::HandleUnused,                                    //473 unused
    &AuraEffect::HandleUnused,                                    //474 unused
    &AuraEffect::HandleUnused,                                    //475 unused
    &AuraEffect::HandleUnused,                                    //476 unused
    &AuraEffect::HandleUnused,                                    //477 unused
    &AuraEffect::HandleUnused,                                    //478 unused
    &AuraEffect::HandleUnused,                                    //479 unused
    &AuraEffect::HandleUnused,                                    //480 unused
    &AuraEffect::HandleUnused,                                    //481 unused
    &AuraEffect::HandleUnused,                                    //482 unused
    &AuraEffect::HandleUnused,                                    //483 unused
    &AuraEffect::HandleUnused,                                    //484 unused
    &AuraEffect::HandleUnused,                                    //485 unused
    &AuraEffect::HandleUnused,                                    //486 unused
    &AuraEffect::HandleUnused,                                    //487 unused
    &AuraEffect::HandleNULL,                                      //488 SPELL_AURA_488 - @TODO
    &AuraEffect::HandleUnused,                                    //489 unused
    &AuraEffect::HandleUnused,                                    //490 unused
    &AuraEffect::HandleNULL,                                      //491 SPELL_AURA_491 - @TODO
    &AuraEffect::HandleUnused,                                    //492 unused
    &AuraEffect::HandleUnused,                                    //493 unused
    &AuraEffect::HandleUnused,                                    //494 unused
    &AuraEffect::HandleUnused,                                    //495 unused
    &AuraEffect::HandleUnused,                                    //496 unused
    &AuraEffect::HandleUnused,                                    //497 unused
    &AuraEffect::HandleUnused,                                    //498 unused
    &AuraEffect::HandleUnused,                                    //499 unused
    &AuraEffect::HandleUnused,                                    //500 unused
    &AuraEffect::HandleUnused,                                    //501 unused
    &AuraEffect::HandleUnused,                                    //502 unused
    &AuraEffect::HandleUnused,                                    //503 unused
    &AuraEffect::HandleUnused,                                    //504 unused
    &AuraEffect::HandleUnused,                                    //505 unused
    &AuraEffect::HandleUnused,                                    //506 unused
    &AuraEffect::HandleUnused,                                    //507 unused
    &AuraEffect::HandleUnused,                                    //508 unused
    &AuraEffect::HandleUnused,                                    //509 unused
    &AuraEffect::HandleUnused,                                    //510 unused
    &AuraEffect::HandleUnused,                                    //511 unused
    &AuraEffect::HandleAuraConvertRune,                           //512 SPELL_AURA_CONVERT_RUNE
    &AuraEffect::HandleUnused,                                    //513 unused
    &AuraEffect::HandleUnused,                                    //514 unused
    &AuraEffect::HandleUnused,                                    //515 unused
    &AuraEffect::HandleUnused,                                    //516 unused
    &AuraEffect::HandleUnused,                                    //517 unused
    &AuraEffect::HandleUnused,                                    //518 unused
    &AuraEffect::HandleUnused,                                    //519 unused
    &AuraEffect::HandleUnused,                                    //520 unused
    &AuraEffect::HandleUnused,                                    //521 unused
    &AuraEffect::HandleUnused,                                    //522 unused
    &AuraEffect::HandleUnused,                                    //523 unused
    &AuraEffect::HandleUnused,                                    //524 unused
    &AuraEffect::HandleUnused,                                    //525 unused
    &AuraEffect::HandleUnused,                                    //526 unused
    &AuraEffect::HandleUnused,                                    //527 unused
    &AuraEffect::HandleUnused,                                    //528 unused
    &AuraEffect::HandleUnused,                                    //529 unused
    &AuraEffect::HandleUnused,                                    //530 unused
    &AuraEffect::HandleUnused,                                    //531 unused
    &AuraEffect::HandleUnused,                                    //532 unused
    &AuraEffect::HandleUnused,                                    //533 unused
    &AuraEffect::HandleUnused,                                    //534 unused
    &AuraEffect::HandleUnused,                                    //535 unused
    &AuraEffect::HandleUnused,                                    //536 unused
    &AuraEffect::HandleUnused,                                    //537 unused
    &AuraEffect::HandleUnused,                                    //538 unused
    &AuraEffect::HandleUnused,                                    //539 unused
    &AuraEffect::HandleUnused,                                    //540 unused
    &AuraEffect::HandleUnused,                                    //541 unused
    &AuraEffect::HandleUnused,                                    //542 unused
    &AuraEffect::HandleUnused,                                    //543 unused
    &AuraEffect::HandleUnused,                                    //544 unused
};
    ...
    if (!amount && caster)
    {
        ...
        if (!itemGUID.IsEmpty())
        {
            if (Player* playerCaster = caster->ToPlayer())
            {
                ...
                {
                    if (castItem->m_itemData->PropertySeed)
                    {
                        if (ItemRandomSuffixEntry const* item_rand_suffix = sItemRandomSuffixStore.LookupEntry(std::abs(castItem->m_itemData->RandomPropertiesID)))
                        {
                            for (uint8 k = 0; k < MAX_ITEM_ENCHANTMENT_EFFECTS; ++k)
                            {
                                if (SpellItemEnchantmentEntry const* pEnchant = sSpellItemEnchantmentStore.LookupEntry(item_rand_suffix->Enchantment[k]))
                                {
                                    for (uint8 t = 0; t < MAX_ITEM_ENCHANTMENT_EFFECTS; ++t)
                                    {
                                        ...
                                        {
                                            amount = uint32((item_rand_suffix->AllocationPct[k] * castItem->m_itemData->PropertySeed) / 10000);
                                            break;
                                        }
                                    }
                                }
...
void AuraEffect::CalculateSpellMod()
{
    switch (GetAuraType())
    {
        ...
        case SPELL_AURA_ADD_PCT_MODIFIER:
            if (!m_spellmod)
            {
                SpellModifier* spellmod = new SpellModifier(GetBase());
...
void AuraEffect::ChangeAmount(int32 newAmount, bool mark, bool onStackOrReapply, AuraEffect const* triggeredBy /* = nullptr */)
{
    ...
    if (GetSpellInfo()->HasAttribute(SPELL_ATTR8_AURA_POINTS_ON_CLIENT))
...
void AuraEffect::CleanupTriggeredSpells(Unit* target)
{
    ...
    SpellInfo const* tProto = sSpellMgr->GetSpellInfo(tSpellId, GetBase()->GetCastDifficulty());
    if (!tProto)
        return;
        ...
        if (target->GetTypeId() == TYPEID_PLAYER)
        {
            ...
            for (uint32 i = 0; i < MAX_GLYPH_SLOT_INDEX; ++i)
            {
                if (uint32 glyphId = target->ToPlayer()->GetGlyph(i))
                {
                    ...
                    {
                        SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(glyph->SpellID, DIFFICULTY_NONE);
            ...
            if (target->ToPlayer()->HasSpell(63410) || target->ToPlayer()->HasSpell(63411))
            {
                ...
                if (GetMiscValue() == FORM_TRAVEL_FORM || GetMiscValue() == FORM_NONE) // "while in Travel Form or while not shapeshifted"
            ...
            switch (GetMiscValue())
            {
                case FORM_CAT_FORM:
                    ...
                    if (AuraEffect const* aurEff = target->GetDummyAuraEffect(SPELLFAMILY_GENERIC, 236161, 0))
                    {
                ...
                case FORM_BEAR_FORM:
                    ...
                    if (AuraEffect const* aurEff = target->GetAuraEffect(SPELL_AURA_MOD_TOTAL_STAT_PERCENTAGE, SPELLFAMILY_DRUID, 132126, 0))
                    {
                        CastSpellExtraArgs args(this);
...
void AuraEffect::HandleModInvisibility(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    {
        // apply glow vision
        if (playerTarget && (type == INVISIBILITY_GENERAL || type == INVISIBILITY_UNK10))
...
void AuraEffect::HandleDetectAmore(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    {
        if (playerTarget->HasAuraType(SPELL_AURA_DETECT_AMORE))
        {
            Unit::AuraEffectList const& amoreAuras = playerTarget->GetAuraEffectsByType(SPELL_AURA_DETECT_AMORE);
        ...
        if (PowerType != POWER_MANA)
        {
            ...
            switch (form)
            {
                ...
                case FORM_DIRE_BEAR_FORM:
                {
                    ...
                    int32 FurorChance = 0;
                    if (AuraEffect const* dummy = target->GetDummyAuraEffect(SPELLFAMILY_DRUID, 135881, 0))
                    ...
                    switch (GetMiscValue())
                    {
                        case FORM_CAT_FORM:
                        {
                            ...
                            target->changedIntoShapeshift = true;
            ...
            case FORM_BERSERKER_STANCE:
            {
                ...
                if (target->GetTypeId() == TYPEID_PLAYER)
                {
                    ...
                    for (PlayerSpellMap::const_iterator itr = sp_list.begin(); itr != sp_list.end(); ++itr)
                    {
                        ...
                        SpellInfo const* spellInfo = sSpellMgr->GetSpellInfo(itr->first, DIFFICULTY_NONE);
                        if (spellInfo && spellInfo->SpellFamilyName == SPELLFAMILY_WARRIOR && spellInfo->IconFileDataId == 136031)
        ...
        if (!transformSpellInfo || !GetSpellInfo()->IsPositive() || transformSpellInfo->IsPositive())
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    // Polymorph (sheep)
                    if (GetSpellInfo()->SpellFamilyName == SPELLFAMILY_MAGE && GetSpellInfo()->IconFileDataId == 136071 && GetSpellInfo()->GetSpellVisual() == 12978)
...
void AuraEffect::HandleAuraTrackResources(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    if (apply)
        target->SetTrackResourceFlag(0, uint32(1) << (GetMiscValue() - 1));
    else
        target->RemoveTrackResourceFlag(0, uint32(1) << (GetMiscValue() - 1));
}
...
void AuraEffect::HandleModConfuse(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    // alistar: totems shouldn't be polymorphable
    if (target->IsTotem())
        return;
...
void AuraEffect::HandleModTotalPercentStat(AuraApplication const* aurApp, uint8 mode, bool /*apply*/) const
{
    ...
    if (GetMiscValue() < -1 || GetMiscValue() > 4)
    {
        TC_LOG_ERROR("spells.aura.effect", "WARNING: Misc Value for {} SPELL_AURA_MOD_PERCENT_STAT not valid", GetId());
        return;
    }
...
void AuraEffect::HandleNoReagentUseAura(AuraApplication const* aurApp, uint8 mode, bool /*apply*/) const
{
    ...
    Player* targetPlayer = aurApp->GetTarget()->ToPlayer();
    if (targetPlayer == nullptr)
        return;

    flag128 mask;
    Unit::AuraEffectList const& noReagent = targetPlayer->GetAuraEffectsByType(SPELL_AURA_NO_REAGENT_USE);
    for (Unit::AuraEffectList::const_iterator i = noReagent.begin(); i != noReagent.end(); ++i)
        mask |= (*i)->GetSpellEffectInfo().SpellClassMask;

    targetPlayer->SetNoRegentCostMask(mask);
}
...
void AuraEffect::HandleAuraOpenStable(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    if (apply)
    {
        CastSpellTargetArg targets(target);

        target->ToPlayer()->CastSpell(target, 63264, {TRIGGERED_FULL_MASK});
        target->ToPlayer()->SendStable(ObjectGuid::Empty);
    }
...
void AuraEffect::HandlePeriodicHealAurasTick(Unit* target, Unit* caster) const
{
    ...
    if (target != caster && GetSpellInfo()->HasAttribute(SPELL_ATTR2_NO_TARGET_PER_SECOND_COSTS) && (!caster || !caster->IsAlive()))
        return;
...
void AuraEffect::HandlePeriodicManaLeechAuraTick(Unit* target, Unit* caster) const
{
    ...
    const auto manaCost = GetSpellInfo()->PowerCosts[POWER_MANA];
    if (manaCost && manaCost->PowerCostPct)
    {
        // max value
