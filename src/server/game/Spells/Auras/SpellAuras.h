...
class TC_GAME_API Aura
{
    ...
    public:
        ...
        */
        ...
        void SetLoadedState(int32 maxDuration, int32 duration, int32 charges, uint8 stackAmount, uint32 recalculateMask, float critChance, bool applyResilience, int32* amount);
