...
public:
    ...
    uint32 GetAuctionsSize() const { return _itemsByAuctionId.size();  }
    ...
    void BuildListBuckets(WorldPackets::AuctionHouse::AuctionListItemsResult& listBucketsResult, Player const* player,
    ...
    std::unordered_multimap<ObjectGuid, uint32>& GetPlayerBidderAuctions() { return _playerBidderAuctions; }
