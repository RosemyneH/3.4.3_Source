...
GameTable<GtChanceToMeleeCrit>                  sChanceToMeleeCrit;
GameTable<GtChanceToMeleeCritBase>              sChanceToMeleeCritBase;
GameTable<GtChanceToSpellCrit>                  sChanceToSpellCrit;
GameTable<GtChanceToSpellCritBase>              sChanceToSpellCritBase;
...
#define LOAD_GT(store, file) gameTableCount += LoadGameTable(bad_gt_files, store, gtPath / file); ++expectedGameTableCount;
    ...
    LOAD_GT(sChanceToMeleeCrit, "ChanceToMeleeCrit.txt");
    LOAD_GT(sChanceToMeleeCritBase, "ChanceToMeleeCritBase.txt");
    LOAD_GT(sChanceToSpellCrit, "ChanceToSpellCrit.txt");
    LOAD_GT(sChanceToSpellCritBase, "ChanceToSpellCritBase.txt");
