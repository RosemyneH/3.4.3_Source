...
{
    // alistar: 1772 is hardcoded into the wotlk classic client
    return 1772; // sAnimationDataStore.GetNumRows();
}
...
int32 DB2Manager::GetNumTalentsAtLevel(uint32 level, Classes playerClass)
{
    ...
    if (numTalentsAtLevel)
        return (playerClass == CLASS_DEATH_KNIGHT) ? numTalentsAtLevel->NumTalentsDeathKnight : numTalentsAtLevel->NumTalents;
