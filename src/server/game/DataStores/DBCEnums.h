...
enum CurrencyConsts
{
    CURRENCY_TYPE_ARENA_POINTS = 1900,
    CURRENCY_TYPE_HONOR_POINTS = 1901,
};
...
enum Difficulty : uint8
{
    ...
    DIFFICULTY_40           = 9,
    DIFFICULTY_20           = 148,
    DIFFICULTY_PARTY_NORMAL = 173,
    DIFFICULTY_PARTY_HEROIC = 174,
    DIFFICULTY_RAID_10_N    = 175,
    DIFFICULTY_RAID_25_N    = 176,
    DIFFICULTY_RAID_10_HC   = 193,
    DIFFICULTY_RAID_25_HC   = 194,
};
...
static constexpr uint8 const MAX_ITEM_PROTO_DAMAGES = 2;
...
enum MapDifficultyResetInterval : uint8
{
    ...
    MAP_DIFFICULTY_RESET_EVERY_3_DAYS = 3,
    MAP_DIFFICULTY_RESET_EVERY_5_DAYS = 4
};
...
#define MAX_SPELL_EFFECTS 11        // alistar: from db2 I've noticed that the largest effectIndex was 10
