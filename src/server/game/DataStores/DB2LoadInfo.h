...
struct CharacterServiceInfoLoadInfo
{
    ...
    {
        { false, FT_INT, "ID" },
        { false, FT_STRING, "FlowTitleLang" },
        { false, FT_STRING, "PopupTitleLang" },
        { false, FT_STRING, "PopupDescriptionLang" },
        { true, FT_INT, "ServiceType" },
    ...
    static constexpr DB2LoadInfo Instance { Fields, 13, &CharacterServiceInfoMeta::Instance, HOTFIX_SEL_CHARACTER_SERVICE_INFO };
};
...
struct GlobalStringsLoadInfo
{
    ...
    {
        { false, FT_INT, "ID" },
        { false, FT_STRING_NOT_LOCALIZED, "BaseTag" },
...
struct StableSlotPricesLoadInfo
{
    ...
    static constexpr DB2LoadInfo Instance{ Fields, std::size(Fields), &StableSlotPricesMeta::Instance, HOTFIX_SEL_STABLE_SLOT_PRICES };
};
...
struct UiExpansionDisplayInfoLoadInfo
{
    static constexpr DB2FieldMeta Fields[5] =
    {
        ...
        { false, FT_INT, "ExpansionLevel" },
        { false, FT_INT, "RelaseType" },
    };

    static constexpr DB2LoadInfo Instance { Fields, 5, &UIExpansionDisplayInfoMeta::Instance, HOTFIX_SEL_UI_EXPANSION_DISPLAY_INFO };
};
