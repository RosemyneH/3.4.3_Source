...
TC_GAME_API extern DB2Storage<CharacterServiceInfoEntry>            sCharacterServiceInfoStore;
...
TC_GAME_API extern DB2Storage<UiExpansionDisplayInfoEntry>          sUiExpansionDisplayInfoStore;
