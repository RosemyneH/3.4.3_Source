...
{
    { GO_FACTORY_DOOR,      BOSS_RHAHKZOR,   EncounterDoorBehavior::OpenWhenDone          },
    { GO_MAST_ROOM_DOOR,    BOSS_SNEED,      EncounterDoorBehavior::OpenWhenDone          },
    { GO_FOUNDRY_DOOR,      BOSS_GILNID,     EncounterDoorBehavior::OpenWhenDone          },
