...
enum PetSpellsMisc
{
    ...
    PET_ICON_ID_GROWL               = 132270,
    PET_ICON_ID_CLAW                = 132140,
    PET_ICON_ID_BITE                = 132127,
    PET_ICON_ID_SMACK               = 132114
};
...
class spell_pet_guard_dog : public AuraScript
{
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        ...
        if (!spellInfo || spellInfo->IconFileDataId != PET_ICON_ID_GROWL)
            return false;
...
class spell_pet_culling_the_herd : public AuraScript
{
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        ...
        switch (spellInfo->IconFileDataId)
        {
